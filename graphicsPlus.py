# CS 151 F22 Computational Thinking: Visual Media Section A
# Lectures MWF 9:00-9:50am --- Lab Thurs 1-2:20pm
# Lecture 18 Zelle objects (Part 1)
# Stacy Doore
# •
# 8:52 AM
# Files are provided as examples of lecture concepts. You will need to download these files into one folder with the graphicPlus.py module for them to run correctly.
...
# CS 151 F22 AB Lecture 18 Zelle graphics objects (Part 1).pdf
# PDF

# CS 151 F22 Zelle graphics package practice (Days 1-2):
# Google Docs
# Class comments
